...
Scena createScena(GLuint program){
    ...
    aux.addObiect(Obiect(1000, "resurse/pereti/horse3.obj", {21,-0.2,7.5}, {180, 1, 90, 0}, s, program));
    aux.addObiect(Obiect(1000, "resurse/pereti/horse3.obj", {21,-0.2,13.8}, {180, 1, 90, 0}, s, program));
